...
/** Public default registry shape expected by the contracts API / tests. */
...
/**
 * Build the public default registry arrays from mock (or supplied) providers.
 * Accepts the object returned by createMockContractProviders().
 */

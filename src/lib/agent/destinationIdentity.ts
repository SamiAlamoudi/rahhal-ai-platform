...
const PLACES: PlaceRow[] = [
  ...
  { keys: ['paris', 'باريس', 'france', 'فرنسا'], city: 'Paris', country: 'France', label: 'Paris' },
  { keys: ['london', 'لندن'], city: 'London', country: 'United Kingdom', label: 'London' },
  { keys: ['istanbul', 'اسطنبول', 'إسطنبول', 'تركيا', 'turkey'], city: 'Istanbul', country: 'Turkey', label: 'Istanbul' },
  { keys: ['cairo', 'القاهرة', 'egypt', 'مصر'], city: 'Cairo', country: 'Egypt', label: 'Cairo' },
  { keys: ['bangkok', 'بانكوك', 'thailand', 'تايلند', 'تايلاند'], city: 'Bangkok', country: 'Thailand', label: 'Bangkok' },
  ...
  { keys: ['switzerland', 'سويسرا', 'zurich', 'زوريخ'], city: 'Zurich', country: 'Switzerland', label: 'Switzerland' },
]

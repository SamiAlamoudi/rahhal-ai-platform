...
const DEFAULT_FEATURES: FeatureDefinition[] = [
  ...
  },
  {
    id: 'live.flights',
    name: 'Live Flights',
    description: 'Enable live flight provider calls (Amadeus).',
    lifecycle: 'stable',
    enabled: false,
    dependsOn: ['providers.live_master'],
    notes: 'Phase AI — OFF by default. Do not enable without Edge secrets.',
  },
  {
    id: 'live.hotels',
    name: 'Live Hotels',
    description: 'Enable live hotel provider calls.',
    lifecycle: 'stable',
    enabled: false,
    dependsOn: ['providers.live_master'],
    notes: 'Phase AI — OFF by default.',
  },
  {
    id: 'live.activities',
    name: 'Live Activities',
    description: 'Enable live activities provider calls.',
    lifecycle: 'experimental',
    enabled: false,
    dependsOn: ['providers.live_master'],
    notes: 'Phase AI — OFF by default; no live adapter yet.',
  },
  {
    id: 'live.transport',
    name: 'Live Transport',
    description: 'Enable live ground transport provider calls.',
    lifecycle: 'experimental',
    enabled: false,
    dependsOn: ['providers.live_master'],
    notes: 'Phase AI — OFF by default; no live adapter yet.',
  },
  {
    id: 'live.payments',
    name: 'Live Payments',
    description: 'Enable live payment capture (Moyasar etc.).',
    lifecycle: 'deprecated',
    enabled: false,
    notes: 'Phase AI — permanently OFF while VITE_PAYMENT_PROVIDER=mock freeze holds.',
  },
  {
    id: 'providers.flights.live',
    name: 'Providers · Flights live',
    description: 'Phase AJ capability flag for live flights (Amadeus).',
    lifecycle: 'stable',
    enabled: false,
    dependsOn: ['providers.live_master'],
    notes: 'OFF by default. Mirrors live.flights / VITE_PROVIDERS_FLIGHTS_LIVE.',
  },
  {
    id: 'providers.hotels.live',
    name: 'Providers · Hotels live',
    description: 'Phase AJ capability flag for live hotels (Booking.com).',
    lifecycle: 'stable',
    enabled: false,
    dependsOn: ['providers.live_master'],
  ...
  {
    id: 'providers.maps.live',
    name: 'Providers · Maps live',
    description: 'Phase AJ capability flag for live maps (Google Maps).',
    lifecycle: 'stable',
    enabled: false,
    dependsOn: ['providers.live_master'],
    notes: 'OFF by default.',
  ...
  {
    id: 'providers.weather.live',
    name: 'Providers · Weather live',
    description: 'Phase AJ capability flag for live weather (OpenWeather).',
    lifecycle: 'stable',
    enabled: false,
    dependsOn: ['providers.live_master'],
    notes: 'OFF by default.',
  ...
  {
    id: 'providers.transport.live',
    name: 'Providers · Transport live',
    description: 'Phase AJ capability flag for live transport (no live adapter yet).',
    lifecycle: 'experimental',
    enabled: false,
    dependsOn: ['providers.live_master'],
    notes: 'OFF by default; mock-only architecture until a live adapter exists.',
  },
  {
    id: 'providers.activities.live',
    name: 'Providers · Activities live',
    description: 'Phase AJ capability flag for live activities (no live adapter yet).',
    lifecycle: 'experimental',
    enabled: false,
    dependsOn: ['providers.live_master'],
    notes: 'OFF by default; mock-only architecture until a live adapter exists.',

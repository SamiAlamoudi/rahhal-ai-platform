 ...
 * Repositories are loaded lazily so mock helpers stay importable in unit tests.
 */
export async function getAdminStatsFromDb(): Promise<AdminStats> {
  try {
    const [
      ...
      import('../repositories/searchHistoryRepository'),
      import('../repositories/savedTripRepository'),

...
| `ai.realtime_voice` | experimental | **no** | Recovery Phase 7 — multi-provider realtime voice + failover (alias: realtime_voice); production OFF; distinct from frozen `voice.realtime` |

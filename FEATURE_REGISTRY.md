...
| `ai.consultant_pipeline` | experimental | **no** | Phase 2 Stage 1 consultant pipeline orchestration — sequences existing layers; not wired to planTurn (alias: consultant_pipeline) |

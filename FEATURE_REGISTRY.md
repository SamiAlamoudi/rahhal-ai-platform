...
| `brain.loyalty_platform` | experimental | **no** | Phase 7 Stage 2 Loyalty Platform Foundation architecture — contracts/types only; depends on `brain.traveler_profile`; no DB/auth/payments/reward calculation/Runtime/HTTP/APIs/LLM (alias: brain_loyalty_platform) |

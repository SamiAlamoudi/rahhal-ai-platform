...
| **Production MVP** | Booking persistence → unified funnel → My Trips → Amadeus sandbox → payments prep → E2E → deploy | **Active** — booking persistence **production-ready**; next: unified booking funnel |

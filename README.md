...
| **Production MVP** | Booking persistence → unified funnel → My Trips → Amadeus sandbox → payments prep → E2E → deploy | **Active** — Amadeus sandbox funnel wiring (opt-in; `docs/AMADEUS_SANDBOX.md`) |
